...
$(function(){console.log("App running...");var t=$("ul li .thumbnail-wrapper"),e=$("ul li a.accept-link, ul li a.reject-link"),n=function(){t.each(function(){var t=$(this),e=t.parent(),n=t.attr("data-accepted");console.log(n),"yes"===n?(e.addClass("accepted"),e.find("a.accept-link").hide(),e.find("a.reject-link").show()):(e.removeClass("accepted"),e.find("a.accept-link").show(),e.find("a.reject-link").hide())})},a=function(t){var e=t.attr("data-accepted");"yes"!==e?c(t):i(t)},c=function(t){var e=t.find("img").attr("src"),n=d();r(n,e,!0,function(){t.addClass("accepted"),t.attr("data-accepted","yes"),t.parent().find("a.accept-link").hide(),t.parent().find("a.reject-link").show(),console.log('Satus changed to "accepted"')})},i=function(t){var e=t.find("img").attr("src"),n=d();r(n,e,!1,function(){t.removeClass("accepted"),t.attr("data-accepted","no"),t.parent().find("a.accept-link").show(),t.parent().find("a.reject-link").hide(),console.log('Satus changed to "rejected"')})},o=function(){t.on("click",function(t){t.preventDefault(),a($(this))}),e.on("click",function(t){t.preventDefault(),a($(this).parent().find(".thumbnail-wrapper"))})},r=function(t,e,n,a){$.ajax({type:"POST",url:_root+"project/"+d()+"/update-status",data:"project_slug="+t+"&filename="+e,success:function(t){return"ok"===t?a():void console.error("Something went wrong with updating this picture's status :(")}})},d=function(){return"todo"};$(".fancybox").fancybox(),n(),o()});