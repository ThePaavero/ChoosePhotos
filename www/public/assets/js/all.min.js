...
$(function(){console.log("App running...");var e=$("ul li .thumbnail-wrapper"),n=function(){e.on("click",a)},c=function(){e.each(function(){var e=$(this),n="yes"===e.data("accepted");if(n){e.addClass("accepted");var c=e.parent();c.prepend('<div class="selected-icon"></div>'),c.find(".accept-link").remove()}else c.find(".reject-link").remove()})},a=function(e){e.preventDefault();var n=$(this).data("accepted");console.log(n)};$(".fancybox").fancybox(),c(),n()});