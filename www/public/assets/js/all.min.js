...
$(function(){console.log("App running...");var t=$("ul"),e=t.find("li .thumbnail-wrapper"),n=t.find("li a.accept-link, li a.reject-link"),a=function(){e.each(function(){var t=$(this),e=t.parent(),n=t.attr("data-accepted");console.log(n),"yes"===n?(e.addClass("accepted"),e.find("a.accept-link").hide(),e.find("a.reject-link").show()):(e.removeClass("accepted"),e.find("a.accept-link").show(),e.find("a.reject-link").hide())})},c=function(t){var e=t.attr("data-accepted");"yes"!==e?i(t):r(t)},i=function(t){var e=t.find("img").attr("src").split("/"),n=e[e.length-1],a=l();s(a,n,!0,function(){t.addClass("accepted"),t.attr("data-accepted","yes"),t.parent().find("a.accept-link").hide(),t.parent().find("a.reject-link").show(),console.log('Satus changed to "accepted"')})},r=function(t){var e=t.find("img").attr("src").split("/"),n=e[e.length-1],a=l();s(a,n,!1,function(){t.removeClass("accepted"),t.attr("data-accepted","no"),t.parent().find("a.accept-link").show(),t.parent().find("a.reject-link").hide(),console.log('Satus changed to "rejected"')})},o=function(){e.on("click",function(t){t.preventDefault(),c($(this))}),n.on("click",function(t){t.preventDefault(),c($(this).parent().find(".thumbnail-wrapper"))})},s=function(t,e,n,a){NProgress.start(),$.ajax({type:"POST",url:_root+"project/"+t+"/update-status",data:"project_slug="+t+"&filename="+e,success:function(t){return NProgress.done(),"ok"===t?a():void console.error("Something went wrong with updating this picture's status :(")}})},l=function(){var e=t.attr("data-projectslug");return e},d=function(){var t=$(".send-email-link");t.on("click",function(t){t.preventDefault();var e=$(this);NProgress.start(),e.attr("disabled",!0),$.ajax({url:e.attr("href"),success:function(t){NProgress.done(),"ok"===t?console.log("Yeah!"):alert(t),setTimeout(function(){e.attr("disabled",!1)},1e3)}})})};$(".fancybox").fancybox(),a(),o(),d()});
