...
$(function(){console.log("App running...");var t=$("ul"),e=t.find("li .thumbnail-wrapper"),n=t.find("li a.accept-link, ul li a.reject-link"),a=function(){e.each(function(){var t=$(this),e=t.parent(),n=t.attr("data-accepted");console.log(n),"yes"===n?(e.addClass("accepted"),e.find("a.accept-link").hide(),e.find("a.reject-link").show()):(e.removeClass("accepted"),e.find("a.accept-link").show(),e.find("a.reject-link").hide())})},c=function(t){var e=t.attr("data-accepted");"yes"!==e?i(t):o(t)},i=function(t){var e=t.find("img").attr("src").split("/"),n=e[e.length-1],a=l();d(a,n,!0,function(){t.addClass("accepted"),t.attr("data-accepted","yes"),t.parent().find("a.accept-link").hide(),t.parent().find("a.reject-link").show(),console.log('Satus changed to "accepted"')})},o=function(t){var e=t.find("img").attr("src").split("/"),n=e[e.length-1],a=l();d(a,n,!1,function(){t.removeClass("accepted"),t.attr("data-accepted","no"),t.parent().find("a.accept-link").show(),t.parent().find("a.reject-link").hide(),console.log('Satus changed to "rejected"')})},r=function(){e.on("click",function(t){t.preventDefault(),c($(this))}),n.on("click",function(t){t.preventDefault(),c($(this).parent().find(".thumbnail-wrapper"))})},d=function(t,e,n,a){$.ajax({type:"POST",url:_root+"project/"+t+"/update-status",data:"project_slug="+t+"&filename="+e,success:function(t){return"ok"===t?a():void console.error("Something went wrong with updating this picture's status :(")}})},l=function(){var e=t.attr("data-projectslug");return e};$(".fancybox").fancybox(),a(),r()});