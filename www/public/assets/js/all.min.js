...
$(function(){console.log("App running...");var t=$("ul li .thumbnail-wrapper"),a=$("ul li a.accept-link, ul li a.reject-link"),e=function(){t.each(function(){var t=$(this),a="yes"===t.data("accepted"),e=t.parent();a?e.addClass("accepted"):e.removeClass("accepted")})},n=function(t){var a=t.attr("data-accepted");"yes"!==a?c(t):o(t)},c=function(t){var a=t.find("img").attr("src");r(a,!0,function(){t.addClass("accepted"),t.attr("data-accepted","yes"),console.log('Satus changed to "accepted"')})},o=function(t){var a=t.find("img").attr("src");r(a,!1,function(){t.removeClass("accepted"),t.attr("data-accepted","no"),console.log('Satus changed to "rejected"')})},i=function(){t.on("click",function(t){t.preventDefault(),n($(this))}),a.on("click",function(t){t.preventDefault(),n($(this).parent().find(".thumbnail-wrapper"))})},r=function(t,a,e){$.ajax({type:"POST",url:_root+"project/"+u()+"/update-status",data:"filename="+t,success:function(t){return"ok"===t?e():void console.error("Something went wrong with updating this picture's status :(")}})},u=function(){return"todo"};$(".fancybox").fancybox(),e(),i()});