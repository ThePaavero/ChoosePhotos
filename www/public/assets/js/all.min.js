...
$(function(){console.log("App running...");var e=$("ul li .thumbnail-wrapper"),c=$("ul li a.accept-link, ul li a.reject-link"),n=function(){e.each(function(){var e=$(this),c="yes"===e.data("accepted"),n=e.parent();c?(e.addClass("accepted"),n.find(".rejected-icon").remove(),n.prepend('<div class="accepted-icon"></div>'),n.find(".accept-link").remove()):(e.removeClass("accepted"),n.find(".accepted-icon").remove(),n.prepend('<div class="rejected-icon"></div>'),n.find(".reject-link").remove())})},a=function(e){e.preventDefault();var c=$(this).parent(),n=c.data("accepted");"yes"!==n?t(c):i(c)},t=function(e){e.addClass("accepted"),e.data("accepted","yes"),console.log("ACCEPTING!")},i=function(e){e.removeClass("accepted"),e.data("accepted","no"),console.log("REJECTING!")},o=function(){e.on("click",a),c.on("click",a)};$(".fancybox").fancybox(),n(),o()});